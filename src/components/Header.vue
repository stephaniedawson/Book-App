        ...
        <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          ...
          <div>
            <div class="mt-10">
                  ...
                  <div class="flex items-center space-x-6 lg:space-x-8">
                    ...
                    <div class="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                      <template v-for="book in books.slice(0, 2)" :key="book">
                        <div class="h-64 w-44 sm:opacity-0 lg:opacity-100">
                          <a :href="book.amazon_product_url" target="_blank"><img :src="book.book_image" alt="" class="w-full object-cover rounded-lg shadow-md shadow-slate-400" /></a>
                        </div>
                      </template>
                    </div>
                    ...
                    <div class="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                      <template v-for="book in books.slice(3, 6)" :key="book">
                        <div class="h-64 w-44 sm:opacity-0 lg:opacity-100">
                          <a :href="book.amazon_product_url" target="_blank"><img :src="book.book_image" alt="" class="h-full w-full object-cover object-center rounded-lg shadow-md shadow-slate-400" /></a>
                        </div>
                      </template>
                    </div>
              ...
              <a href="#" class="inline-block rounded-md border border-transparent bg-emerald-600 py-3 px-8 text-center font-medium text-white hover:bg-slate-700">Browse Books</a>
            </div>
          </div>
        </div>
      </div>
